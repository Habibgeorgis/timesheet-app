...
export default async function TimesheetDetail({params}:{params:Promise<{id:string}>}) {
  ...
  const defaultEntryDate=isCurrentWeek?dateKey(new Date()):dateKey(timesheet.weekStart);
  return <>
    ...
    <div className="mb-6"><EntryForm timesheetId={id} defaultDate={defaultEntryDate}/></div>

import { BarChart3, CalendarDays, Clock3, FileText, LayoutDashboard, LogOut, Users } from "lucide-react";
import Link from "next/link";
import type { User } from "@prisma/client";
import { logout } from "@/actions/auth";
import { initials } from "@/lib/utils";

const links=[{href:"/dashboard",label:"Overview",icon:LayoutDashboard},{href:"/timesheets",label:"My timesheets",icon:CalendarDays},{href:"/reports",label:"Reports",icon:BarChart3}];
